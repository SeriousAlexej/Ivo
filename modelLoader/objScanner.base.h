...
#ifndef ObjScannerBASE_H_INCLUDED
#define ObjScannerBASE_H_INCLUDED
...
public:
    ObjScannerBase(ObjScannerBase const &other)             = delete;
    ObjScannerBase &operator=(ObjScannerBase const &rhs)    = delete;
...
protected:
    ObjScannerBase(std::istream &in, std::ostream &out);
    ObjScannerBase(std::string const &infilename, std::string const &outfilename);
...
inline std::ostream &ObjScannerBase::out()
{
    return *d_out;
}

inline void ObjScannerBase::push(size_t ch)
{
    d_input.reRead(ch);
}

inline void ObjScannerBase::push(std::string const &str)
{
    d_input.reRead(str, 0);
}

inline bool ObjScannerBase::atFinalState()
{
    return d_final.notAtBOL.rule != std::numeric_limits<size_t>::max() || 
            (d_atBOL && d_final.atBOL.rule != std::numeric_limits<size_t>::max());
}

inline void ObjScannerBase::setFilename(std::string const &name)
{
    d_filename = name;
}

inline void ObjScannerBase::setMatched(std::string const &text)
{
    d_matched = text;
}

inline std::string const &ObjScannerBase::matched() const
{
    return d_matched;
}

inline ObjScannerBase::StartCondition__ ObjScannerBase::startCondition() const
{
    return d_startCondition;
}

inline std::string const &ObjScannerBase::filename() const
{
    return d_filename;
}

inline void ObjScannerBase::echo() const
{
    *d_out << d_matched;
}

inline size_t ObjScannerBase::length() const
{
    return d_matched.size();
}

inline void ObjScannerBase::leave(int retValue) const
{
    throw static_cast<Leave__>(retValue);
}

inline size_t ObjScannerBase::lineNr() const
{
    return d_input.lineNr();
}

inline void ObjScannerBase::more()
{
    d_more = true;
}

inline void ObjScannerBase::begin(StartCondition__ startCondition)
{
    d_dfaBase__ = 
        s_dfaBase__[static_cast<int>(d_startCondition = startCondition)];
}

inline size_t ObjScannerBase::state__() const
{
    return d_state;
}

inline size_t ObjScannerBase::get__()
{
    return d_input.get();
}

inline bool ObjScannerBase::return__()
{
    return d_return;
}

inline void ObjScannerBase::noReturn__()
{
    d_return = false;
}


#endif //  ObjScannerBASE_H_INCLUDED
