...
#ifndef ObjParserBase_h_included
#define ObjParserBase_h_included
...
// $insert polymorphicSpecializations
    ...
    {
        static Tag__ const tag = Tag__::_STRING;
    };

    template <>
    struct TagOf<float>
    {
        static Tag__ const tag = Tag__::_FLOAT;
    };

    template <>
    struct TypeOfBase<Tag__::_STRING>
    {
        typedef std::string DataType;
    };

    template <>
    struct TypeOfBase<Tag__::_FLOAT>
    {
...
inline bool ObjParserBase::debug() const
{
    return d_debug__;
}

inline void ObjParserBase::setDebug(bool mode)
{
    d_debug__ = mode;
}

inline void ObjParserBase::ABORT() const
{
    throw PARSE_ABORT__;
}

inline void ObjParserBase::ACCEPT() const
{
    throw PARSE_ACCEPT__;
}

inline void ObjParserBase::ERROR() const
{
...
#define ObjParser ObjParserBase
